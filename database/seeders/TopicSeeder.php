    ...
    public function run(): void
    {
        $curriculumTopics = [
            ...
            'christian-religious-studies' => [
                ...
                'Covenant, Obedience and Faith',
                'The Prophets and Social Justice',
                'The Teachings of Jesus Christ',
                'The Early Church and the Holy Spirit',
                'Christian Living, Family and Community',
                'Faith, Hope and Love',
            ],
            'islamic-religious-studies' => [
                'The Qur’an: Revelation, Preservation and Compilation',
                'Tajwid and Qur’anic Recitation',
                'The Hadith and Sunnah',
                'Tawhid, Articles of Faith and Worship',
                'The Life and Leadership of Prophet Muhammad',
                'Islamic Ethics, Family Life and Social Values',
                'Islamic Law, Justice and Economic Principles',
                'Islam in West Africa and Nigeria',
            ],
            'geography' => [
                'The Earth as a Planet and Map Reading',
                'Latitude, Longitude, Time and Scale',
                'The Earth’s Structure, Rocks and Landforms',
                'Weather, Climate and Climate Change',
                'Soils, Vegetation and Environmental Resources',
                'Population, Settlement and Urbanisation',
                'Agriculture, Industry, Transport and Trade',
                'Regional Geography of Nigeria, Africa and the World',
            ],
            'history' => [
                'Pre-Colonial Nigeria and West African Societies',
                'Trans-Saharan and Trans-Atlantic Trade',
                'Islam, Christianity and Social Change',
            ...
            'insurance' => [
                'Meaning, History and Principles of Insurance',
                'Insurance Contract and Policy Documents',
                'Life Assurance',
                'Fire, Marine and Motor Insurance',
                'Accident, Liability and Engineering Insurance',
