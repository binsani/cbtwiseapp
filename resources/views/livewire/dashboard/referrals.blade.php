<div class="dashboard-shell max-w-5xl font-sans space-y-6 sm:space-y-8">
    ...
    <div class="dashboard-page-header">
        <div>
            <h1 class="dashboard-page-title font-heading">Refer & Earn</h1>
            <p class="dashboard-page-subtitle">Invite your classmates to CBTWise. Get rewarded when they upgrade!</p>
        </div>
