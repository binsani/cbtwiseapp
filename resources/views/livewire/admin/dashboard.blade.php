                ...
                <div>
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <a href="{{ route('admin.questions') }}" class="flex flex-col p-3.5 rounded-2xl border border-slate-100 hover:border-emerald-300 hover:bg-emerald-50/40 transition-all group">
                            <span class="w-8 h-8 rounded-xl bg-emerald-100/70 text-emerald-700 flex items-center justify-center text-sm font-bold mb-2 group-hover:scale-105 transition-transform">??</span>
                        ...
                        <a href="{{ route('admin.bulk-seeder') }}" class="flex flex-col p-3.5 rounded-2xl border border-slate-100 hover:border-amber-300 hover:bg-amber-50/40 transition-all group">
                            <span class="w-8 h-8 rounded-xl bg-amber-100/70 text-amber-700 flex items-center justify-center text-sm font-bold mb-2 group-hover:scale-105 transition-transform">?</span>
                        ...
                        <a href="{{ route('admin.exams-subjects') }}" class="flex flex-col p-3.5 rounded-2xl border border-slate-100 hover:border-blue-300 hover:bg-blue-50/40 transition-all group">
                            <span class="w-8 h-8 rounded-xl bg-blue-100/70 text-blue-700 flex items-center justify-center text-sm font-bold mb-2 group-hover:scale-105 transition-transform">??</span>
                        ...
                        <a href="{{ route('admin.users') }}" class="flex flex-col p-3.5 rounded-2xl border border-slate-100 hover:border-purple-300 hover:bg-purple-50/40 transition-all group">
                            <span class="w-8 h-8 rounded-xl bg-purple-100/70 text-purple-700 flex items-center justify-center text-sm font-bold mb-2 group-hover:scale-105 transition-transform">??</span>
                        ...
                        <a href="{{ route('admin.subscriptions') }}" class="flex flex-col p-3.5 rounded-2xl border border-slate-100 hover:border-teal-300 hover:bg-teal-50/40 transition-all group">
                            <span class="w-8 h-8 rounded-xl bg-teal-100/70 text-teal-700 flex items-center justify-center text-sm font-bold mb-2 group-hover:scale-105 transition-transform">??</span>
                        ...
                        <a href="{{ route('admin.analytics') }}" class="flex flex-col p-3.5 rounded-2xl border border-slate-100 hover:border-rose-300 hover:bg-rose-50/40 transition-all group">
                            <span class="w-8 h-8 rounded-xl bg-rose-100/70 text-rose-700 flex items-center justify-center text-sm font-bold mb-2 group-hover:scale-105 transition-transform">??</span>
