...
<div class="min-h-screen flex flex-col items-center justify-center px-4 py-12" style="background: #f0faf4;"
    ...
    <div class="w-full max-w-md">
        ...
        <div class="flex bg-slate-100 rounded-2xl p-1 mb-8">
            <button type="button"
                @click="tab = 'login'"
                :class="tab === 'login' ? 'bg-white text-slate-900 shadow-sm' : 'text-slate-500 hover:text-slate-700'"
                class="flex-1 py-2.5 text-sm font-bold rounded-xl transition-all">
                Login
            </button>
            <button type="button"
                @click="tab = 'code'"
                :class="tab === 'code' ? 'bg-white text-slate-900 shadow-sm' : 'text-slate-500 hover:text-slate-700'"
                class="flex-1 py-2.5 text-sm font-bold rounded-xl transition-all">
                Purchase Code
            </button>
        </div>
            ...
            <form wire:submit="login" class="space-y-5">
                ...
                <div class="space-y-1.5">
                    ...
                    <input
                        ...
                        class="w-full px-4 py-3 bg-white border border-slate-200 focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/10 rounded-xl text-sm font-medium text-slate-900 placeholder:text-slate-400 shadow-sm transition-all outline-none @error('form.email') border-red-300 @enderror"
                    />
                    @error('form.email')
                ...
                <div class="space-y-1.5" x-data="{ show: false }">
                    ...
                    <div class="relative">
                        <input
                            ...
                            placeholder="••••••••"
                            class="w-full px-4 py-3 pr-11 bg-white border border-slate-200 focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/10 rounded-xl text-sm font-medium text-slate-900 placeholder:text-slate-400 shadow-sm transition-all outline-none @error('form.password') border-red-300 @enderror"
                        />
            ...
            <form wire:submit="loginWithPurchaseCode" class="space-y-5">
                ...
                <div class="space-y-1.5">
                    ...
                    <input
                        ...
                        autocomplete="off"
                        style="font-family: 'Courier New', monospace; letter-spacing: 0.05em; text-transform: uppercase;"
                ...
                <button
                    type="submit"
                    class="w-full py-3.5 px-6 rounded-full font-bold text-sm text-white transition-all flex items-center justify-center gap-2"
                    style="background: #2d6a4f;"
                    onmouseover="this.style.background='#1b4332'" onmouseout="this.style.background='#2d6a4f'"
                >
